            ...
            return (
              ...
              >
                <button 
                  ...
                  className="absolute top-4 right-4 z-10 p-2 bg-white/50 dark:bg-black/50 rounded-full backdrop-blur-sm opacity-0 group-hover:opacity-100 hover:scale-110 transition-all duration-300"
