    ...
    return (
        <div className="relative min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-100 dark:bg-black">
            <div className="absolute inset-0 overflow-hidden">
                <img src="https://images.pexels.com/photos/1552249/pexels-photo-1552249.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="Login background" className="w-full h-full object-cover" onContextMenu={(e) => e.preventDefault()} />
